...
<section class="w-full relative flex justify-center items-center min-h-screen">
    ...
    >
        ...
        <label class="flex items-center gap-4">
            <input type="checkbox" name="agree_tok" required bind:checked={acceptedToS} />
            <span>
                I agree to be a good kbity when using the Nikodex :3 (aka you agree to the
                <a href="/tos">Terms of Service</a> of the Nikodex)
            </span>
        </label>
